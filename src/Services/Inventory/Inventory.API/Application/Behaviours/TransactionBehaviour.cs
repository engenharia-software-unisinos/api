...
namespace Inventory.API.Application.Behaviours
{
    public class TransactionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        ...
        public TransactionBehaviour(InventoryContext dbContext,
            ...
            ILogger<TransactionBehaviour<TRequest, TResponse>> logger)
        {
            ...
            _inventoryIntegrationEventService = inventoryIntegrationEventService ?? throw new ArgumentException(nameof(inventoryIntegrationEventService));
