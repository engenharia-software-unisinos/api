...
namespace Inventory.API.Application.DomainEventHandlers.ItemRemoved
{
    public class ItemStatusChangedToRemovedDomainEventHandler : INotificationHandler<ItemStatusChangedToRemovedDomainEvent>
    {
        ...
        public ItemStatusChangedToRemovedDomainEventHandler(IProductRepository itemRepository, IIdentityService identityService, ILoggerFactory logger, IInventoryIntegrationEventService inventoryIntegrationEventService)
        {
