...
namespace Ordering.API.Infrastructure.Migrations
{
    ...
    [Migration("20210912171134_Initial_Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("itemseq", "ordering")
                .IncrementsBy(10);
            ...
            modelBuilder.Entity("Ordering.Domain.AggregatesModel.ItemAggregate.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ordering.Domain.AggregatesModel.ItemAggregate.ProductStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("Ordering.Domain.AggregatesModel.ItemAggregate.Product", b =>
                {
                    b.HasOne("Ordering.Domain.AggregatesModel.ItemAggregate.ProductStatus", "ProductStatus")
                        .WithMany()
