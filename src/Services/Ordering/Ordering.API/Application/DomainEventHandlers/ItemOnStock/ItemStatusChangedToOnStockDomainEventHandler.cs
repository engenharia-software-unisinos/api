...
namespace Ordering.API.Application.DomainEventHandlers.ItemOnStock
{
    public class ItemStatusChangedToOnStockDomainEventHandler : INotificationHandler<ItemStatusChangedToOnStockDomainEvent>
    {
        ...
        public ItemStatusChangedToOnStockDomainEventHandler(IProductRepository itemRepository, IIdentityService identityService, ILoggerFactory logger, IOrderingIntegrationEventService inventoryIntegrationEventService)
        {
